...
<body>
            ...
            <div class="page" id="scanner-page">
                ...
                <div class="scanner-container">
                    ...
                    <div class="scanner-controls">
                        ...
                        <button class="btn-scan btn-success" id="simulateScanBtn">Simulasikan Scan</button>
                    </div>
    ...
    <script>
        ...
        function simulateScan() {
            // Simulate scanning a product (use the first product as example)
            if (products.length > 0) {
                const randomProduct = products[Math.floor(Math.random() * products.length)];
                addToCart(randomProduct.id);
                showNotification(`${randomProduct.title} berhasil di-scan dan ditambahkan ke keranjang`);
            } else {
                alert('Tidak ada produk yang tersedia untuk di-scan.');
            }
        }
